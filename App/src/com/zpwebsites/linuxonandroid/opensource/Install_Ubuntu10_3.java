...
public class Install_Ubuntu10_3 extends DashboardActivity {
	...
	protected void onCreate(Bundle paramBundle) {
		...
		setContentView(R.layout.install_ubuntu10_3);
	...
	private OnClickListener btn_Next_onClick = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent(v.getContext(), Install_Ubuntu10_4.class);
