...
public class Install_Ubuntu12_1 extends DashboardActivity {
	...
	protected void onCreate(Bundle paramBundle) {
		...
		setContentView(R.layout.install_ubuntu12_1);
	...
	private OnClickListener btn_Next_onClick = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent(v.getContext(), Install_Ubuntu12_2.class);
