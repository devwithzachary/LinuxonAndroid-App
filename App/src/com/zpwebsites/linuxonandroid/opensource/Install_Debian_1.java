...
public class Install_Debian_1 extends DashboardActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView (R.layout.install_debian_1);
	...
	private OnClickListener btn_Next_onClick = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent(v.getContext(), Install_Debian_2.class);
