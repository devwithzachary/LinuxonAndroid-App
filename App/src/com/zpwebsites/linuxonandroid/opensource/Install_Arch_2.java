...
public class Install_Arch_2 extends DashboardActivity {
	...
	protected void onCreate(Bundle paramBundle) {
		...
		setContentView(R.layout.install_arch_2);
	...
	private OnClickListener btn_DownloadImage_onClick = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent(v.getContext(), Download_Arch_menu.class);
	...
	private OnClickListener btn_Next_onClick = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent(v.getContext(), Install_Arch_3.class);
			v.getContext().startActivity(intent);
		}
	};
