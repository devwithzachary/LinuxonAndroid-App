...
public class Ubuntu_Activity extends Activity {

	public static final String			PREFS_NAME			= "UbuntuWidgetPrefs";
	public static final String			cfg_Image			= "UbuntuImage";
	...
	@Override public void onCreate(Bundle savedInstanceState) {
		...
		if (file_Exists(CFG.MNT + "/home/")) { // A image is already mounted, offer user to chroot into it now
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(Ubuntu_Activity.this);
