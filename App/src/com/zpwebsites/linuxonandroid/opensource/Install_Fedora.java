...
public class Install_Fedora extends BaseActivity {
	TabHost nTabHost;
	...
	public void onCreate(Bundle savedInstanceState) {
    	mTitleRes = R.string.fedora_guide;
        ...
        nTabsAdapter.addTab(nTabHost.newTabSpec("Fedora1").setIndicator("Page 1"),
                Install_Fedora_1.class, null);
        nTabsAdapter.addTab(nTabHost.newTabSpec("Fedora2").setIndicator("Page 2"),
        		Install_Fedora_2.class, null);
        nTabsAdapter.addTab(nTabHost.newTabSpec("Fedora3").setIndicator("Page 3"),
        		Install_Fedora_3.class, null);
        nTabsAdapter.addTab(nTabHost.newTabSpec("Fedora4").setIndicator("Page 4"),
        		Install_Fedora_4.class, null);
