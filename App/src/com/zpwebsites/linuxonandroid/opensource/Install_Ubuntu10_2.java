...
public class Install_Ubuntu10_2 extends DashboardActivity {
	...
	protected void onCreate(Bundle paramBundle) {
		...
		setContentView(R.layout.install_ubuntu10_2);
	...
	private OnClickListener btn_DownloadImage_onClick = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent(v.getContext(), Download_Ubuntu10_Menu.class);
	...
	private OnClickListener btn_Next_onClick = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent(v.getContext(), Install_Ubuntu10_3.class);
			v.getContext().startActivity(intent);
		}
	};
