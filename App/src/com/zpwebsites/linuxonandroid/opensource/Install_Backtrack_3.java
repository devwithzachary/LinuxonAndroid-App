...
public class Install_Backtrack_3 extends DashboardActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView (R.layout.install_backtrack_3);
	...
	private OnClickListener btn_Next_onClick = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent(v.getContext(), Install_Backtrack_4.class);
