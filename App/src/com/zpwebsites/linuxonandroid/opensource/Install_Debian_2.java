...
public class Install_Debian_2 extends DashboardActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView (R.layout.install_debian_2);
	...
	private OnClickListener btn_DownloadImage_onClick = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent(v.getContext(), Download_Debian_Menu.class);
	...
	private OnClickListener btn_Next_onClick = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent(v.getContext(), Install_Debian_3.class);
			v.getContext().startActivity(intent);
		}
	};
