...
//Used for the Backtrack widget
public class Backtrack_Activity extends Activity {

	public static final String			PREFS_NAME			= "BacktrackWidgetPrefs";
	...
	@Override public void onCreate(Bundle savedInstanceState) {
		...
		if (file_Exists(CFG.MNT + "/home/")) { // A image is already mounted, offer user to chroot into it now
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(Backtrack_Activity.this);
